...
import com.example.crsm_g8.Repository.AccountRepository;
import com.example.crsm_g8.Repository.ContractDetailRepository;
import com.example.crsm_g8.Repository.ContractRepository;
import com.example.crsm_g8.Repository.ParkingRepository;

import com.example.crsm_g8.untils.*;
...
//          paymentEntity.setStaffEntity(staffEntity);
    ...
    public ResponseEntity<?> responseResultContract(List<ContractEntity> contractEntities, List<ContractEntity> contractEntities1, Integer size, Integer p) {
        ...
        contractEntities.forEach(ContractEntity -> {
            ...
            contractResponse = com.example.crsm_g8.Entity.ContractEntity.convertToContractResponse(ContractEntity);
